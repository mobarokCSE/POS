...
<div class="page-content fade-in-up">
    <div class="card shadow">
        <div class="card-header bgView cardB">
            <div class="row">
                <h4 class="col-md-6 heading_h4">All Product List</h4>
                <div class="col-md-6">
                ...
                <tbody>
                    @foreach ($product as $key=> $row)  
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('edit.product',$row->id)}}" class="badge badge-pill badge-primary"><i class="fa fa-pencil"></i></a>
                                ...
                                <a href="{{route('view.product',$row->id)}}" class="badge badge-pill badge-success"><i class="fa fa-eye"></i></a>
                            </td>
                        </tr> 
                    @endforeach
                </tbody>
