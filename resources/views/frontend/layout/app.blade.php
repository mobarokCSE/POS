 ...
 <head>
     ...
     <!-- Magnific Popup -->
     <link rel="stylesheet" href="{{ asset('asset/frontend/css/magnific-popup.min.css') }}">
     <!-- Font Awesome -->
     <link rel="stylesheet" href="{{ asset('asset/frontend/css/font-awesome.css') }}">
     <!-- Fancybox -->
     <link rel="stylesheet" href="{{ asset('asset/frontend/css/jquery.fancybox.min.css') }}">
     <!-- Themify Icons -->
     <link rel="stylesheet" href="{{ asset('asset/frontend/css/themify-icons.css') }}">
     <!-- Nice Select CSS -->
     <link rel="stylesheet" href="{{ asset('asset/frontend/css/niceselect.css') }}">
     <!-- Animate CSS -->
     <link rel="stylesheet" href="{{ asset('asset/frontend/css/animate.css') }}">
     <!-- Flex Slider CSS -->
     <link rel="stylesheet" href="{{ asset('asset/frontend/css/flex-slider.min.css') }}">
     <!-- Owl Carousel -->
     <link rel="stylesheet" href="{{ asset('asset/frontend/css/owl-carousel.css') }}">
     <!-- Slicknav -->
     <link rel="stylesheet" href="{{ asset('asset/frontend/css/slicknav.min.css') }}">

     <!-- Eshop StyleSheet -->
     <link rel="stylesheet" href="{{ asset('asset/frontend/css/reset.css') }}">
 ...
 <body class="js">
             ...
             <div class="container">
                 <div class="row">
                     <div class="col-lg-2 col-md-2 col-12">
                         <!-- Logo -->
                         <div class="logo">
                             <a href="index.html"><img src="{{ asset('asset') }}/frontend/images/logo.png"
                                     alt="logo"></a>
                         </div>
                         <!--/ End Logo -->
                         <!-- Search Form -->
     ...
     <!-- Slider Area -->
     @include('frontend.partial.heroSlider');
     <!--/ End Slider Area -->

     <!-- Start Small Banner  -->
     @include('frontend.partial.smlBanner');
     <!-- End Small Banner -->
     ...
     <!-- Start Midium Banner  -->
     @include('frontend.partial.mdBanner');
     <!-- End Midium Banner -->

     <!-- Start Most Popular -->
     @include('frontend.partial.popularProduct');
     <!-- End Most Popular Area -->

     <!-- Start Shop Home List  -->
     @include('frontend.partial.shopHome');
     <!-- End Shop Home List  -->

     <!-- Start Cowndown Area -->
     @include('frontend.partial.cownDown');
     <!-- /End Cowndown Area -->

     <!-- Start Shop Blog  -->
     @include('frontend.partial.shopBlog');
     <!-- End Shop Blog  -->

     <!-- Start Shop Services Area -->
     @include('frontend.partial.shopService');
     <!-- End Shop Services Area -->

     <!-- Start Shop Newsletter  -->
     @include('frontend.partial.shopNewsletter');
     <!-- End Shop Newsletter -->
                     ...
                     <div class="col-lg-5 col-md-6 col-12">
                         ...
                         <div class="single-footer about">
                             ...
                             <p class="text">Praesent dapibus, neque id cursus ucibus, tortor neque egestas
                                 augue, magna eros eu erat. Aliquam erat volutpat. Nam dui mi, tincidunt quis, accumsan
     ...
     <script src="{{ asset('asset/frontend/js/jquery-migrate-3.0.0.js') }}"></script>
     ...
     <!-- Color JS -->
     <script src="{{ asset('asset/frontend/js/colors.js') }}"></script>
     <!-- Slicknav JS -->
     <script src="{{ asset('asset/frontend/js/slicknav.min.js') }}"></script>
     <!-- Owl Carousel JS -->
     <script src="{{ asset('asset/frontend/js/owl-carousel.js') }}"></script>
     <!-- Magnific Popup JS -->
     <script src="{{ asset('asset/frontend/js/magnific-popup.js') }}"></script>
     <!-- Waypoints JS -->
     <script src="{{ asset('asset/frontend/js/waypoints.min.js') }}"></script>
     <!-- Countdown JS -->
     <script src="{{ asset('asset/frontend/js/finalcountdown.min.js') }}"></script>
     <!-- Nice Select JS -->
     <script src="{{ asset('asset/frontend/js/nicesellect.js') }}"></script>
     <!-- Flex Slider JS -->
     <script src="{{ asset('asset/frontend/js/flex-slider.js') }}"></script>
     <!-- ScrollUp JS -->
     <script src="{{ asset('asset/frontend/js/scrollup.js') }}"></script>
     <!-- Onepage Nav JS -->
     <script src="{{ asset('asset/frontend/js/onepage-nav.min.js') }}"></script>
     <!-- Easing JS -->
     <script src="{{ asset('asset/frontend/js/easing.js') }}"></script>
     <!-- Active JS -->
